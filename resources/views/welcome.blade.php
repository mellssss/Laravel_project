...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="{{ URL::asset('lte/plugins/jquery-mousewheel/jquery.mousewheel.js') }}"></script>
<script src="{{ URL::asset('lte/plugins/raphael/raphael.min.js') }}"></script>
<script src="{{ URL::asset('lte/plugins/jquery-mapael/jquery.mapael.min.js' )}}"></script>
<script src="{{ URL::asset('lte/plugins/jquery-mapael/maps/usa_states.min.js')}}"></script>
<!-- ChartJS -->
